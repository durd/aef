...
| Loopback10 | VRF10_VTEP_DIAGNOSTICS | VRF10 | 10.255.10.23/32 |
| Loopback11 | VRF11_VTEP_DIAGNOSTICS | VRF11 | 10.255.11.23/32 |
...
```eos
!
ip address virtual source-nat vrf VRF10 address 10.255.10.23
ip address virtual source-nat vrf VRF11 address 10.255.11.23
```
